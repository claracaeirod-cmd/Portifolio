/* Animated WebGL prism background rendered into #prism-container.
   Uses the OGL library (loaded from esm.sh) to raymarch a rotating
   anisotropic pyramid with hue-shifting glow. */
